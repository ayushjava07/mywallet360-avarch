...
export function PortfolioHoldings({ holdings, valuationHistory, isLoading, displayMode, ethPrice, wallet }) {
  ...
  return (
    <section className="card holdings-card p-5 max-[480px]:p-3.5">
      ...
      <div className="holdings-total mb-4">
            ...
            {donutData.map((entry) => (
              <div
                ...
                className={`holdings-legend-item flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg cursor-pointer text-[11px] ${
                  activeSymbol === entry.name ? 'bg-gray-100 dark:bg-white/[0.08]' : ''
                }`}
